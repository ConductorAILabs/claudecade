...
DUNGEONS = {
    'Thornwood Cave': {
        ...
        'chests':{(8,5):('Hi-Potion',2),(2,11):('Ether',2)},
    },
    'Magma Forge': {
        ...
        'chests':{(19,3):('Hi-Ether',2),(16,7):('Mega-Potion',2),(5,11):('Power Glove',1)},
    },
    'SYNTHOS Core': {
...
def _build_map():
    ...
    fill(2, 4, 13, 19, '^')
    fill(3, 5, 12, 18, '.')     # interior grass

    # Pass col 20, rows 2-13
    fill(2, 20, 13, 20, '.')

    # Region 2: mountain shell rows 2-13, cols 21-45
    fill(2, 21, 13, 45, '^')
    fill(3, 22, 12, 44, '.')    # interior grass

    # Pass col 46, rows 2-13
    fill(2, 46, 13, 46, '.')

    # Region 3: mountain shell rows 2-13, cols 47-76
    fill(2, 47, 13, 76, '^')
    fill(3, 48, 12, 75, '.')    # interior grass
